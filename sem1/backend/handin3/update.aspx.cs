...
namespace handin3
{
    public partial class update : System.Web.UI.Page
    {
        ...
        protected void GridViewTrains_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            TextBoxDelayAmount.Text = GridViewTrains.SelectedRow.Cells[19].Text;

            //showing delayid and the current delay
            LabelMessages.Text = "Your chose DelayID: " +
            GridViewTrains.SelectedRow.Cells[17].Text + " and it currently has a delay of " +
            GridViewTrains.SelectedRow.Cells[19].Text + " minutes";
        }
        ...
        protected void ButtonUpdate_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = null;
            string sqlUpdate = "update delay set delayAmount = @delayAmount where delayID = @delayID";
            ...
            try
            {
                ...
                cmd.ExecuteNonQuery();
                LabelMessages.Text = "Delay has been updated";
            }
            catch (Exception ex) //if there are errors
            {
                LabelMessages.Text = ex.Message;
